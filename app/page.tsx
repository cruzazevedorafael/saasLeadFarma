...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="sticky top-20 z-30 bg-background/80 backdrop-blur-xl border-b border-border/40 py-4">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-12 pr-4 rounded-full bg-muted border border-border/50 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#CFFF04]/50 focus:border-[#CFFF04]/50 transition-all"
              />
            </div>
          </motion.div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            >
              ...
              <button
                ...
                className="mt-4 text-sm text-[#CFFF04] hover:underline"
              >
                Limpar filtros
              </button>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full border-2 border-[#CFFF04]/30 overflow-hidden">
